...
/**
 * by moosphon on 2018/09/27
 * desc:多媒体资源多选控件
 */
public class MultiMediaCheckView extends View{
    ...
    public MultiMediaCheckView(Context context) {
        super(context);
        init(context);
    }

    public MultiMediaCheckView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public MultiMediaCheckView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context) {
        ...
        TypedArray ta = getContext().getTheme().obtainStyledAttributes(new int[]{R.attr.item_checkView_border_color});
    ...
    private void initBackgroundPaint() {
        if (mBackgroundPaint == null) {
            ...
            TypedArray ta = getContext().getTheme()
                    .obtainStyledAttributes(new int[]{R.attr.item_checkView_background_startColor, R.attr.item_checkView_background_endColor});
            int startColor = ta.getColor(0, getResources().getColor(R.color.black));
            ta.recycle();
            mBackgroundPaint.setColor(startColor);
            //mBackgroundPaint.setShader(new LinearGradient(0f, 0f, SIZE * mDensity, SIZE * mDensity, startColor, endColor, Shader.TileMode.CLAMP));
        }
    }
